...
@push('js-after')
<script src="{{asset('js/ajax/letter.js')}}"></script>
@endpush
    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                Anda dapat melihat daftar surat yang tersedia di platform e-surat pada halaman ini
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                ...
                                <table class="table table-striped" id="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nama Surat</th>
                                            <th style="max-width: 100px">Pelayanan Mandiri</th>
