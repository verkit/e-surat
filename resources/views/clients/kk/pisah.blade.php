        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-lg-8">
                ...
                <div class="card register-card bg-gray p-1 p-sm-4 mb-50">
                    <div class="card-body">
                        <h4>Formulir KK Pisah</h4>
                        <p>Perbarui KK Lama terlebih dahulu</p>
                        <!-- Register Form-->
                        <form method="POST" action="{{route('simpan.kk')}}" autocomplete="off">
                            @csrf
                            <div class="row">
                                @include('clients.kk.form')
                                <input type="text" name="is_separate" value="1" readonly hidden>
                                <input type="text" name="is_new" value="0" readonly hidden>
                            </div>
